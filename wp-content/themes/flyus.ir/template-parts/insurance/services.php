<?php $servic_setting = fly_insurance_get_option('fly_insurance_services_options');?>
<section class="services">
            <div class="container">
                <div class="main-title">
                    <h2 class="main-title__heading">
                    <?php echo fly_insurance_get_option('fly_insurance_services_main_title_options'); ?>
                    </h2>
        ...
        foreach ($servic_setting as $item) { ?>
                    <div class="col-12 col-md-5">
                        <article class="services-box">
                            <div class="services-box__header">
                                ...
                                <img width="24" height="24" src="<?php if(isset($item['fly_insurance_services_svg_option'])){echo $item['fly_insurance_services_svg_option'];}  ?>">

                                </div>
                                <h3 class="services-box__title"><?php if(isset($item['fly_insurance_services_title_option'])) {echo $item['fly_insurance_services_title_option'];}  ?></h3>
                            </div>
                            <div class="services-box__body">
                                <p>
                                <?php if(isset($item['fly_insurance_services_desc_option'])){echo $item['fly_insurance_services_desc_option'];} ?>
                                </p>
                            </div>
                            <div class="services-box__footer">
                                ...
                                <a href="<?php if(isset($item['fly_insurance_services_link_option'])){echo $item['fly_insurance_services_link_option'] ;}?>" class="services-box__footer-link">
                                    بیشتر
                                    <svg width="22" height="24" viewBox="0 0 22 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M12.8817 16.6129L7.96061 11.6918C7.76963 11.5008 7.76061 11.1826 7.94048 10.981L12.5741 5.78847"
                                            stroke="#094899" stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
            ...
            <div class="services-shadow__right right shadow shadow-right"></div>
        </section>
