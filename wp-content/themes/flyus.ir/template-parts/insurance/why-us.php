<?php $why_setting = fly_insurance_get_option('fly_insurance_why_options');?>
<section class="reason">
            <div class="container line-bg">
                <div class="main-title">
                    <h2 class="main-title__heading">
                    <?php echo fly_insurance_get_option('fly_insurance_why_main_title_options'); ?>
                    </h2>
        ...
        foreach ($why_setting as $item) { ?>
                    <article class="reason-box">
                        ...
                        <img  width="52" height="57" class="reason-box__icon" src="<?php if(isset($item['fly_insurance_why_img_options'])){echo $item['fly_insurance_why_img_options'];} ?>">

                            <h3 class="reason-box__container-title">
                            <?php if(isset($item['fly_insurance_why_title_option'])){echo $item['fly_insurance_why_title_option'];} ?>
                            </h3>
                        </div>
                    </article>
                    <?php }
