<?php $faq_setting= fly_insurance_get_option('fly_insurance_faq_options');?>
<section class="faq">
        <div class="container">
          <div class="main-title">
            <h2 class="main-title__heading"><?php echo fly_insurance_get_option('fly_insurance_faq_main_title_options'); ?></h2>
            <svg
        ...
        foreach ($faq_setting as $item) { ?>
                <div class="accordion-item <?php if($counter==0)echo 'active'?>">
                  <div class="accordion-button">
                    ...
                    <?php if(isset($item['fly_insurance_faq_question_option'])){echo $item['fly_insurance_faq_question_option'];} ?>
                    </h4>
                  ...
                  <?php if(isset($item['fly_insurance_faq_answer_option'])){echo $item['fly_insurance_faq_answer_option'];} ?>
                  </p>
                </div>
                <?php $counter++ ;
                }
            ...
            <div class="col-12 col-md-5 col-lg-6">
              ...
              <img
                  src="<?php if(!empty(fly_insurance_get_option('fly_insurance_faq_main_img_options'))){echo fly_insurance_get_option('fly_insurance_faq_main_img_options');} ?>"
                  alt="FAQ"
