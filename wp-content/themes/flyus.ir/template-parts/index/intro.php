<?php $banner_setting = fly_home_get_option('fly_home_banner_options'); ?>
<section class="intro">
        <h1 class="intro__heading">
          <span class="intro__heading-frist"><?php if(isset($banner_setting[0]['fly_home_banner_title_option'])){echo $banner_setting[0]['fly_home_banner_title_option']; } ?></span>
          <span class="intro__heading-second">
          <?php if(isset($banner_setting[0]['fly_home_banner_subtitle_option'])){echo $banner_setting[0]['fly_home_banner_subtitle_option'];} ?>
            <svg
              class="intro__heading-second--icon"
              width="18"
              height="18"
              viewBox="0 0 18 18"
              fill="none"
        ...
        <div class="container">
          ...
          <img
              src="<?php if(isset($banner_setting[0]['fly_home_banner_img_option'])){echo $banner_setting[0]['fly_home_banner_img_option'];} ?>"
              alt="fly with us"
        ...
        <svg
          class="intro__cloud-left cloud_left"
          width="80"
          height="32"
          viewBox="0 0 80 32"
          fill="none"
        ...
        <svg
          class="intro__cloud-right cloud_right"
          width="97"
          height="23"
          viewBox="0 0 97 23"
          fill="none"
        ...
        <div class="intro-shadow shadow intro-shadow-right"></div>
      </section>         