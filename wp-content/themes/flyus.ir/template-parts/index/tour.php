 <section class="tour">
        <div class="container">
          <div class="main-title">
            <h2 class="main-title__heading">لیست تور های خوش قیمت</h2>
            <svg
              ...
              <?php 
                    $args = array(
                        ...
                        'tax_query' => array(
                            array(
                                ...
                                'terms' => 'best-price' //if field is ID you can reference by cat/term number
                            )
                        )
                    );
                    ...
                    if ($query->have_posts()) :
                        while ($query->have_posts()):
                            $query->the_post(); 
                            $gallery=get_post_meta( get_the_ID(), 'fly_tour_gallery_meta', true ); 
                ...
                <div class="swiper-slide">
                  <div class="slider">
                    <div class="slider__destanition">
                      <div class="slider__destanition-header">
                        <span class="slider__destanition-header--item"
                          >مبدا</span
                        >
                        <span class="slider__destanition-header--item"
                          >مقصد</span
                      ...
                      <?php if(!empty($ticket_q[0]['fly_tour_origin_meta'])) { ?> <p class="slider__destanition-body--item"><?php echo $ticket_q[0]['fly_tour_origin_meta'] ?></p> <?php } ?>
                        <div class="slider__destanition-body--icon">
                          <svg
                            width="17"
                            height="16"
                            viewBox="0 0 17 16"
                        ...
                        <?php if(!empty($ticket_q[0]['fly_tour_destination_meta'])) { ?><p class="slider__destanition-body--item"><?php echo $ticket_q[0]['fly_tour_destination_meta'] ?></p> <?php } ?>
                      </div>
                    ...
                    <div class="slider__body">
                      <div class="slider__body-banner">
                        ...
                        <?php if(!empty($gallery[0]['fly_tour_gallery_img_meta'])) { ?>
                          <img
                            src="<?php echo $gallery[0]['fly_tour_gallery_img_meta'] ?>"
                            alt=""
                      ...
                      <a href="<?php the_permalink() ?>" class="slider__body-link">مشاهده تور</a>
                    </div>
                  </div>
                </div>
