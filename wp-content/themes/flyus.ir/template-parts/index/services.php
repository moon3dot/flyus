<?php $servic_setting = fly_home_get_option('fly_home_services_options');?>
<section class="services" id="services">
        <div class="container">
          <div class="main-title">
            <h2 class="main-title__heading"><?php echo fly_home_get_option('fly_home_services_main_title_options'); ?></h2>
            <svg
              ...
              <article class="services-box">
                <div class="services-box__header">
                  <div class="services-box__icon">
                    <img width="24" height="24" src="<?php if(isset($item['fly_home_services_svg_option'])){echo $item['fly_home_services_svg_option'];}  ?>">
                  </div>
                  <h3 class="services-box__title"><?php if(isset($item['fly_home_services_title_option'])) {echo $item['fly_home_services_title_option'];}  ?></h3>
                </div>
                <div class="services-box__body">
                  <p>
                  <?php if(isset($item['fly_home_services_desc_option'])){echo $item['fly_home_services_desc_option'];} ?>
                  </p>
                </div>
                <div class="services-box__footer">
                  ...
                  <a href="<?php if(isset($item['fly_home_services_link_option'])){echo $item['fly_home_services_link_option'] ;}?>" class="services-box__footer-link">
                    بیشتر
                    <svg
                      width="22"
                      height="24"
