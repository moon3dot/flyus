                ...
                <div class="row">
                    <div class="landing-popularity__title">
                        <div class="main-title">
                            <?php if(!empty($video[0]['fly_trip_section_video_title_meta'])) { ?>
                                <h2 class="main-title__heading"><?php echo $video[0]['fly_trip_section_video_title_meta'] ?> </h2>
                             <?php } ?>
                    ...
                    <?php if(!empty($video[0]['fly_trip_section_video_des_img_meta'])) { ?>
                        <p class="landing__description-paragraph"><?php echo $video[0]['fly_trip_section_video_des_img_meta'] ?> </p>
                    <?php } ?>
                     
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="landing__description-banner">
                        <?php if(!empty($video[0]['fly_trip_section_video_img_meta'])) { ?>
                            <img src="<?php echo $video[0]['fly_trip_section_video_img_meta'] ?>" alt="..." class="landing__description-img">
                        <?php } ?>
