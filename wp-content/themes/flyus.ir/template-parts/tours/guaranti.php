<section class="tour-list__guaranti">
            <div class="container">
                <div class="main-title">
                    ...
                    <?php echo fly_tour_get_option('fly_tour_guaranti_main_title_options'); ?>
                    </h2>
                ...
                <?php if(!empty(fly_tour_get_option('fly_tour_guaranti_main_desc_options'))) echo fly_tour_get_option('fly_tour_guaranti_main_desc_options'); ?>
