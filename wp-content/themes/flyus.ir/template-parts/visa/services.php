<?php $servic_setting = fly_visa_get_option('fly_visa_services_options');?>
<section class="services">
      <div class="container line-bg">
        <div class="main-title">
          <h2 class="main-title__heading"><?php echo fly_visa_get_option('fly_visa_services_main_title_options'); ?></h2>
        ...
        foreach ($servic_setting as $item) { ?>
          <article class="reason-box">
            <div class="reason-box__container">
              <img class="reason-box__icon" width="57" height="57" src="<?php if(isset($item['fly_visa_services_svg_option'])){echo $item['fly_visa_services_svg_option'];}  ?>"> 
              <h3 class="reason-box__container-title">
              <?php if(isset($item['fly_visa_services_title_option'])) {echo $item['fly_visa_services_title_option'];}  ?>
              </h3>
            </div>
          </article>
          <?php } 
