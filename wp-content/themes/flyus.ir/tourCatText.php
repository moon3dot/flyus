...
">
                                                        <div class="flight-timing">
                                                            ...
                                                            <!-- مدت زمان پرواز -->
                                                            <div class="col-12 col-sm-6" style=" display: flex; width: 41rem;">
                                  
                                <?php if(!empty($infoFly[0]['fly_tour_time_flight_one_meta'])) { ?> <span class="flight-timing__item flight-timing__item-start">
                ...
                <?php }  ?>
                                                ...
                                                <div class="col-12 col-sm-6" style="    margin-right: -181px; display: flex; width: 41rem;">
